...
def generate_combinations(columns: List[str]) -> Dict[frozenset, List[str]]:
    """
...
def find_matching_combination(combos: Dict[frozenset, List[str]], target_columns: List[str]) -> Optional[List[str]]:
    """
